...
const Banner = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-4xl bg-slate-900 bg-opacity-25 p-5 rounded-lg">
      <h1 className="mb-5 text-3xl md:text-6xl font-bold"> <span className='text-yellow-400'>Hello,</span>  I am Farhan Fardid</h1>
      <h4 className='mb-5 text-xl md:text-3xl font-semibold text-violet-500'>Full Stack MERN Developer</h4>
      ...
      <h3 className="mb-5 text-xl md:text-4xl font-bold">Discover My Web Development Skills</h3>
