...
const Navigation = () => {
  return (
    ...
    >
      <Navbar.Brand href="#">
        <img alt="Logo" className="mr-3 h-16 w-20 p-1 " src={logo} />
      ...
      <div className="flex md:order-2">
        <a
          href="https://drive.google.com/file/d/1Zn60edlY3t7iHKcr7ekMTeQbTnrIBgU8/view"
          target="blank"
        >
          <Button className="btn-xs md:btn-md  bg-purple-700 hover:bg-purple-900">
            View Resume
          </Button>
        </a>
        <Navbar.Toggle />
