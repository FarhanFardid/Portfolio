...
const Projects = () => {
    return (
        <div id="projects" className='bg-gradient-to-r from-[#661e80] to-[#0f0215] py-3'>
            <h3 className='text-2xl md:text-5xl font-bold text-yellow-400 text-center md:py-7 py-5 '>Projects</h3>
  ...
  <div className="card-body">
    <h2 className="card-title font-bold text-black text-base md:text-xl">Sportz Blitz Summer Camp</h2>
    <p className='text-black text-xs md:text-base'><span className='font-bold '>Introducing Sportz Blitz Summer Camp :</span> A full Stack (MERN) Sports Camp website. Your ultimate destination for summer sports camp. This website provides students, instructors, and administrators with a seamless experience for managing and participating in summer camps. With Firebase authentication for user management and React Stripe for online payments.(Please visit the live site for better experience and visit repository for more details.)</p>
    
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Tools & Technologies:</span> React, React Router, Tailwind CSS, Daisy UI, React Awesome Component, TanStack Query, Axios, React Hook Form, Firebase, JWT, React Stripe.js, Node, Express.js, and MongoDB etc.</p>
...
<div className="card lg:card-side bg-violet-400 shadow-xl border-2">
  ...
  <div className="card-body">
    <h2 className="card-title font-bold text-black text-base md:text-xl" >Kids Heaven</h2>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Introducing Kids Heaven :</span> A full-stack (MERN) Toy Shop website, your ultimate destination for a diverse toy collection. Enjoy an immersive browsing experience akin to visiting a real toy store. With Firebase authentication, securely sign up and log in to access all toys. Users can perform CRUD operations, categorize toys for easy navigation, and search by name. (Please visit the live site for better experience and visit repository for more details.)</p>
 
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Tools & Technologies :</span> React, React Router, Firebase, Tailwind CSS, Daisy UI, Material UI, React Tabs, React Toastify, CORS,
...
<div className="card lg:card-side bg-violet-400 shadow-xl border-2">
  ...
  <div className="card-body">
    <h2 className="card-title font-bold text-black text-base md:text-xl">Diner Lounge Restaurant</h2>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Introducing Diner Lounge :</span>  A full stack comprehensive Restaurant Management System that caters to both administrators and customers. With separate admin and customer dashboards, Diner Lounge offers a seamless experience for managing restaurant operations and placing orders. Firebase authentication and React Stripe for payment processing. (Please visit the live site for better experience and visit repository for more details.)</p>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Tools & Technologies:</span>  React, React Router, Firebase, Node, Express.js, MongoDB, Tailwind CSS, Axios, TanStack Query, React Hook Form, JWT, DaisyUI etc.</p>
    <div className="card-actions justify-between pt-2">
...
<div className="card lg:card-side bg-violet-400 shadow-xl border-2">
  ...
  <div className="card-body">
    <h2 className="card-title font-bold text-black text-base md:text-xl">Task Genius</h2>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Introducing Task Genius :</span>  A a full-stack project designed to streamline task management for users. This platform allows users to efficiently add, update, and remove tasks, ensuring a seamless workflow. It include the ability to add new tasks by providing details such as name, description etc. Updating task status. View all tasks and can removed completed tasks. (Please visit the live site for better experience and visit repository for more details.)</p>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Tools & Technologies:</span>  React, React Router, Node, Express.js, MongoDB, Tailwind CSS, React Hook Form, DaisyUI etc.</p>
    <div className="card-actions justify-between pt-2">
...
<div className="card lg:card-side bg-violet-400 shadow-xl border-2">
  ...
  <div className="card-body">
    <h2 className="card-title font-bold text-black text-base md:text-xl">Cafe Fajitas</h2>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Introducing Cafe Fajitas :</span> A culinary journey by skilled chefs at Cafe. Discover a delightful gastronomic adventure with a diverse array of meticulously crafted recipes. Utilizing Firebase authentication, securely explore chef profiles and recipes. Personalize your experience by saving favorites and receiving notifications. Server-loaded chef data, secure Firebase authentication. (Please visit the live site for better experience and visit repository for more details.)</p>
    <p className='text-black text-xs md:text-base'><span className='font-bold'>Tools & Technologies:</span>  React, React Router, Firebase, Bootstrap, React Bootstrap, React Toastify, SweetAlert, CORS, Node, and Express.js etc.</p>
    <div className="card-actions justify-between pt-2">
