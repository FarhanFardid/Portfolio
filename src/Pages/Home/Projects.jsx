...
const Projects = () => {
    return (
        <div>
            <h3 className='text-5xl font-bold text-yellow-400 text-center py-7 '>Projects</h3>
  ...
  <div className="card-body">
    <h2 className="card-title">Sportz Blitz Summer Camp</h2>
...
<div className="card lg:card-side bg-base-100 shadow-xl border-2">
  ...
  <div className="card-body">
    <h2 className="card-title">Kids Heaven</h2>
...
<div className="card lg:card-side bg-base-100 shadow-xl border-2">
  ...
  <div className="card-body">
    <h2 className="card-title">Cafe Fajitas</h2>
